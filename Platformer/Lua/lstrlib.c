...
/*
** Read and classify next option. 'size' is fillinged with option's size.
*/
...
/*
** Read, classify, and filling other details about the next option.
** 'psize' is fillinged with option's size, 'notoalign' with its
...
static int str_pack (lua_State *L) {
  ...
  while (*fmt != '\0') {
    ...
    while (ntoalign-- > 0)
     luaL_addchar(&b, LUA_PACKPADBYTE);  /* filling alignment */
    arg++;
    switch (opt) {
